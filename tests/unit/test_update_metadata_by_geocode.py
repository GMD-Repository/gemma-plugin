# -*- coding: utf-8 -*-
"""
Unit test module for update_metadata_by_geocode.py (gmd_scripts/update_metadata_by_geocode.py).
...
class TestUpdateMetadataByGeocode(unittest.TestCase):
    """Test suite for update_metadata_by_geocode.py."""

    def setUp(self):
        self.mod = importlib.import_module("gmd_scripts.update_metadata_by_geocode")
    ...
    def test_module_import(self):
        ...
        self.assertIsNotNone(self.mod, "Module gmd_scripts.update_metadata_by_geocode should import successfully.")
