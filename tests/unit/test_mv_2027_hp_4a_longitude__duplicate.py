# -*- coding: utf-8 -*-
"""
Unit test module for mv_2027_hp_4a_longitude__duplicate.py
"""
...
class TestMv2027Hp4aLongitudeDuplicate(unittest.TestCase):
    """Test suite for mv_2027_hp_4a_longitude__duplicate.py."""

    def setUp(self):
        self.gmdhelpers = importlib.import_module("gmd_scripts.gmdhelpers")
        self.mod = importlib.import_module("gmd_scripts.cbms_mv.mv_2027_hp_4a_longitude__duplicate")
        self.alg_cls = getattr(self.mod, "mv_2027_hp_4a_longitude__duplicate")
        self.alg = self.alg_cls()

    def test_algorithm_metadata(self):
        """Verify algorithm metadata return values."""
        self.assertEqual(self.alg.name(), "mv_2027_hp_4a_longitude__duplicate")
        self.assertEqual(self.alg.displayName(), "mv_2027_hp_4a_longitude__duplicate")
