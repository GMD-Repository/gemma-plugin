# -*- coding: utf-8 -*-
"""
Unit test module for geom_check_repair_legacy.py (gmd_scripts/geom_check_repair_legacy.py).
Tests module import and resolve_processing_output_layer helper function.
"""
...
class TestGeomCheckRepairLegacy(unittest.TestCase):
    """Test suite for geom_check_repair_legacy module."""

    def setUp(self):
        self.mod = importlib.import_module("gmd_scripts.geom_check_repair_legacy")
        self.sample_layer = create_sample_polygon_layer("Barangay_Boundaries", count=3)

    def test_module_import(self):
        """Verify module imports successfully."""
        self.assertIsNotNone(self.mod, "Module gmd_scripts.geom_check_repair_legacy should import successfully.")
