import os
from qgis.PyQt.QtCore import Qt, QVariant, QPoint
from qgis.PyQt.QtWidgets import (
    QDialog, QVBoxLayout, QHBoxLayout, QLabel, QPushButton,
    QGroupBox, QCheckBox, QTextEdit, QWidget, QFrame,
...
from qgis.core import (
    ...
    QgsProcessingContext, QgsProcessingUtils, QgsRectangle,
    QgsProcessingFeatureSourceDefinition, QgsFeature, QgsWkbTypes
)
...
class GeometryCheckRepairLegacyDialog(QDialog):
    """
    Standalone Geometry Check & Repair (Legacy) Tool.
    Chronological 3-step workflow:
    1. Scan Geometry Errors
    2. Repair Polygon Geometries
    3. UPSERT Repaired Features to Layer
    """

    def __init__(self, iface, parent=None):
        super().__init__(parent or iface.mainWindow())
        self.iface = iface
        self.setWindowTitle("Geometry Check & Repair (Legacy)")
        self.resize(920, 740)
        self.setWindowFlags(
    ...
    def _build_ui(self):
        ...
        # Header Title
        title_label = QLabel("Geometry Check & Repair (Legacy)")
        title_label.setWordWrap(True)
        title_label.setStyleSheet("font-size: 15px; font-weight: bold; color: #2C3E50; padding: 2px 0;")
        main_layout.addWidget(title_label)

        sub_label = QLabel("Legacy standalone geometry error scanner, auto-repair, and UPSERT tool.")
