...
<qgis version="2.6.1-Brighton" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{671ce8ed-30a5-4ee9-aada-befcb7fe3b71}">
      <rule scalemaxdenom="5000" key="{6a5ca20a-b71b-478f-a419-cc000a40c7ee}" symbol="0" label="Bridge, Barangayl (Large)"/>
      <rule scalemaxdenom="10000" key="{f2cd9dcf-cc33-4c5c-a248-ae1ae472f556}" symbol="1" scalemindenom="5000" label="Bridge, Barangayl (Medium)"/>
    </rules>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/textColorB" value="147"/>
    <property key="labeling/textColorG" value="147"/>
    <property key="labeling/textColorR" value="147"/>
